/*! For license information please see main.09ba42e4.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      463: (e, n, t) => {
  ...
  (t.m = e),
    ...
    (t.u = (e) => "static/js/" + e + ".e22fb591.chunk.js"),
    (t.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var n = (n, r) => {
        ...
        r = (self.webpackChunkel_impostor = self.webpackChunkel_impostor || []);
    ...
    (() => {
          ...
          children: [
            i &&
              (0, r.jsxs)("div", {
                ...
                children: [
                  (0, r.jsx)("div", { className: "loader" }),
                  (0, r.jsx)("div", {
                    className: "updating-message",
            ...
            (0, r.jsxs)("div", {
              children: [
                (0, r.jsx)("label", {
                  htmlFor: "numSala",
                  children: "N\xfamero de jugadores:",
                }),
                (0, r.jsx)("input", {
                  type: "text",
                  id: "numJug",
                ...
                (0, r.jsx)("button", {
                  onClick: () => {
                    c <= 2
                      ? alert(
                          "Debe ingresar un n\xfamero de jugadores v\xe1lido"
                        )
                      : fetch(
                          "https://impostor.propiedadesrainbow.cl/api/sala/".concat(
                            c
                          )
                        )
                          .then((e) => e.json())
                          .then((e) => {
                            if (
                              e &&
                              "Sala creada con \xe9xito" === e.message &&
                              e.hasOwnProperty("0")
                            ) {
                              const n = e[0];
                              u(!0), a(n);
                              ...
                              console.error(
                                "Respuesta inesperada al crear la sala:",
                                e
                              );
                          })
                          .catch((e) => {
                            console.error("Error al actualizar cartas:", e);
                          });
                  },
                  children: "Crear Sala",
                }),
                  ...
                  (0, r.jsx)("div", {
                    children: (0, r.jsx)("div", {
                      children: (0, r.jsx)("button", {
                        onClick: () => {
                          fetch(
                            "https://impostor.propiedadesrainbow.cl/api/palabras/".concat(
                              l
                            ),
                            {
                              method: "PUT",
                            ...
                            .then((e) => {
                              e && "" !== e.message
                                ? alert("Listo para actualizar cartas")
                                : console.error(
                                    "Respuesta inesperada al crear la sala:",
                                    e
                                  );
                            ...
                            .catch((e) => {
                              console.error("Error al actualizar sala:", e);
                            });
                        },
                        children: "Actualizar Sala",
                      }),
                    }),
                  }),
              ],
                ...
                s(!0),
                  setTimeout(() => {
                    fetch(
                      ...
                      .then((e) => {
                        if (e) {
                          if ("Eres el impostor" === e.mensaje)
                            return (
                              console.log("impostor"),
                              t("Eres el impostor"),
                              void s(!1)
                            );
                          if ("Sala llena" === e.mensaje)
                            return (
                          ...
                          {
                            const n = e.map((e) => e.palabra);
                            console.log(n), t(n), s(!1);
                          }
                        } else
                          console.error(
                            "Respuesta inesperada al actualizar las cartas:",
                            e
                          );
                      })
                      .catch((e) => {
                        console.error("Error al actualizar las cartas:", e);
                      });
                  }, 1e3);
              },
              children: "Actualizar Cartas",
            }),
          ],
        });
      };
      const a = function (e) {
        ...
        if (n.length < 9)
          return (
            console.error("No hay suficientes palabras para llenar la carta."),
            null
          );
        const t = [];
        for (let r = 0; r < 9; r += 3) t.push(n.slice(r, r + 3));
        return (0, r.jsxs)("div", {
          className: "carta",
          children: [
            (0, r.jsx)("h2", { children: "Carta de Palabras" }),
            (0, r.jsx)("div", {
              className: "grid-container",
              children: (() => {
                if ("Eres el impostor" === n)
                  return (0, r.jsxs)("div", {
                    className: "carta-impostor",
                    children: [
                      (0, r.jsx)("h2", { children: "\xa1Eres el impostor!" }),
                      (0, r.jsx)("p", {
                        children: "\xa1Act\xfaa con astucia!",
                      }),
                    ],
                  });
                if ("Sala llena" === n)
                  return (0, r.jsx)("div", {
                    className: "carta-impostor",
                    children: (0, r.jsx)("h2", { children: "\xa1Sala llena!" }),
                  });
                let e = 0;
                return t.map((n, t) =>
                  (0, r.jsx)(
      ...
      const o = function () {
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [
              ...
              (0, r.jsx)(a, { palabras: n.length > 0 ? n : [] }),
            ],
          });
        },
        u = (e) => {
...
//# sourceMappingURL=main.09ba42e4.js.map
